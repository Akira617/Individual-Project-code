...
def test_model(test_iter, model, device):
    ...
    np.save('target2.npy', target_container)
    np.save('predict2.npy', predict_container)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-ft_dir', type=str, default='./dataset/train', help='train image directory')
    ...
    # state_dict = torch.load('./model/squeeze2_model.pth')
